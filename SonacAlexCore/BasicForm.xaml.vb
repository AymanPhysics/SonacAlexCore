...
Public Class BasicForm
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Select Case TableName
            Case "Status"
                If bm.IF_Exists("select top 1 InvoiceNo from EntryDt where StatusId=" & txtID.Text) _
                    OrElse bm.IF_Exists("select top 1 InvoiceNo from BankCash_G2 where StatusId=" & txtID.Text) Then
