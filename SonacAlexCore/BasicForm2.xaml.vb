...
Public Class BasicForm2
    ...
    Private Sub BasicForm2_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Flag = 2 Then
            bm.Fields = {MainId, SubId, SubName, "HideFromAccountEnd"}
            bm.control = {CboMain, txtID, txtName, HideFromAccountEnd}
        Else
            HideFromAccountEnd.Visibility = Windows.Visibility.Hidden
        End If
